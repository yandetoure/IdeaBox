<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 nav-bar">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 nav">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="45">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150 profil">
